  ...
  <script>
  	$(function(){
  		$("#modifyBtn").click(function(){
  			...
  			var bcontent = $(".article").text();
  			var bdate = $("#bdate").text();
  			location.href="notice_modify.jsp?btitle="+btitle+"&bcontent="+bcontent;
  			//location.href="notice_modify.jsp?btitle=게시글내용&bdate="+bdate;
  		});
  	});
  </script>
  <style>
...
<body>
  ...
  <section>
    ...
    <table>
      <tr>
        <th id="btitle">2020년 이용 시간 and 이용 요금 변경 안내</th>
      </tr>
      <tr>
        <td id="bdate">2023-11-11</td>
      </tr>
      <tr>
        <td class="article">이미지내용은 키즈잼 2020년 변경사항안내입니다.
    ...
    <div class="list" id="modifyBtn">수정</div>
  </section>
