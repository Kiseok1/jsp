...
<%@include file="top.jsp" %>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <td><%= i %></td>
        <td class="table-title"><a href="notice_read.jsp?bno=<%=i%>">카카오플러스 친구 오픈</a></td>
        <td><%= today_str %></td>
      </tr>
    ...
    <ul class="page-num">
      ...
      <%for(int i=1;i<=10;i++){%>  
      <li class="num">
        <div><a href="S02?page=<%=i%>&searchword=sum"><%= i %></a></div>
      </li>
      <%}%>
      <li class="next"></li>
      <li class="last"></li>
    ...
    <div class="write"><a href="notice_write.jsp">쓰기</a></div>
  </section>
