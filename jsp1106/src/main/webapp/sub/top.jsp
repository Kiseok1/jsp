		...
		<div id="snbBox">
			...
			<div id="quickmenu">
				...
				<ul>
					...
					<li><a href="../customer/notice.jsp">CUSTOMER</a></li>
					<li><a href="../community/comment.jsp">COMMUNITY</a></li>
				</ul>
			</div>
			<div id="snb">
				<ul>
					<li><a href="../member/login.jsp">LOGIN</a></li>
					<li><a href="../member/step01.jsp">JOIN</a></li>
		...
		<div id="top">
			<ul>
				...
				<li class="t2"><a href="#" id="topNavi2">원두</a>
					<ul id="topSubm2">
						<li><a href="../product/list.jsp">클래스</a></li>
