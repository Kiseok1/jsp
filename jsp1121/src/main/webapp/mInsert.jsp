		...
		<script>
			$(function(){
				...
				$("#idCheck").click(function(){
					...
					$.ajax({
						//url:"https://apis.data.go.kr/B551011/PhotoGalleryService1/galleryList1?serviceKey=sKe85StkgFyudlehNxdYvHO%2FVbPFkE4zfeoL6gMCaH0ttJ45eBnbe%2FPoUNWU06A0hTBXV5h37VlsYvkUtbOGjA%3D%3D&numOfRows=10&pageNo=1&MobileOS=ETC&MobileApp=AppTest&arrange=A&_type=json",       //url 확인 주소
